...
plt.plot(val_acc_df['Epoch'], val_acc_df['Fold 1'], 'r-', label='Fold 1', linewidth=2)
...
plt.plot(val_acc_df['Epoch'], val_acc_df['Fold 4'], 'y--', label='Fold 4', linewidth=0.5)
plt.plot(val_acc_df['Epoch'], val_acc_df['Fold 5'], 'k--', label='Fold 5', linewidth=0.5)
plt.legend()
plt.ylabel('Accuracy')
plt.xlabel('Epochs')
plt.grid(False)
plt.savefig('./figures/result-analysis-val-acc.png')
plt.show()